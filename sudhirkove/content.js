...
const parentHeadingQuery = "h3";
const titleQuery = "div[class='ant-tabs-extra-content']";
const timestampQuery = 'span[class="bmpui-ui-playbacktimelabel"]';
...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
  if (msg.action === "getParentTitle") {
    ...
    const title = slugifyTitle(rawTitle);
